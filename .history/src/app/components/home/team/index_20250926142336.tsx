            ...
            <div className="flex flex-col gap-11">
              <div className="flex flex-col gap-5">
                ...
                <p className="max-w-2xl text-gray-700 dark:text-white/70 text-base md:text-lg leading-relaxed">
                  Our guides bring Zimbabwe’s wild landscapes and India’s rich heritage to life. Discover Victoria Falls, Jaipur palaces, hidden gems, and local culture with our passionate team ensuring every tour is safe and memorable.
                </p>
              </div>
            </div>
          </div>
