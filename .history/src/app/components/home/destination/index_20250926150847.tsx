      ...
      <div className="relative mt-10">
        ...
        >
          {topDestination.map((item: Destination, index: number) => (
            ...
            >
              <Image
                src={item.image}        // must be in /public or remote domain configured
                alt={`A stunning view of ${item.place}`}
                width={384}             // corresponds to w-96
                height={320}            // corresponds to h-80
                className="object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out rounded-xl"
                />
